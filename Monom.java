...
public class Monom implements function{
	...
	public Monom(String s) {
		...
		catch (NumberFormatException e) { System.out.println("syntax error");}
		...
		if(S.length <= 1) {
			...
			if(!S[1].contains("^"))
				throw new NumberFormatException("syntax erorr");
			...
			catch (NumberFormatException e) {System.out.println("syntax erorr");}
