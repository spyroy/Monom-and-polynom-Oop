...
class ComplexFunctionTest {
	...
	void testComplexFunction() 
	{
		...
		ComplexFunction cf = new ComplexFunction(Operation.Plus,M,m);
	...
	void testMul() {
		...
		ComplexFunction cf = new ComplexFunction(Operation.Times,M,m);
		System.out.println(cf);
	...
	void testDiv() {
		...
		ComplexFunction cf = new ComplexFunction(Operation.Divid,M,m);
		System.out.println(cf);
	...
	void testMax() {
		...
		ComplexFunction cf = new ComplexFunction(Operation.Max,M,m);
		System.out.println(cf);
	...
	void testMin() {
		...
		ComplexFunction cf = new ComplexFunction(Operation.Min,M,m);
		System.out.println(cf);
	...
	void testComp() {
		...
		ComplexFunction cf = new ComplexFunction(Operation.Comp,M,m);
		System.out.println(cf);
	...
	void testequals() {
		Polynom p = new Polynom ("x^5");
		Polynom m = new Polynom ("x^7");
		ComplexFunction cf1 = new ComplexFunction("Plus",p,m);
		ComplexFunction cf2 = new ComplexFunction("Plus",p,m);
